...
return [
    ...
    */
    ...
    'project_logo'   => '<b>All</b>Commerce',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-warning border-0 navbar navbar-light',
    ...
    'body_class' => 'app aside-menu-fixed sidebar-lg-show bg-dark text-dark',
    ...
    'footer_class' => 'app-footer d-print-none bg-info text-dark',
    // hide it with d-none
