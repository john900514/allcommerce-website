...
@if(count($merchants = \AnchorCMS\Merchants::clientMerchants(backpack_user()->getActiveClientId())) > 0)
...
@if(count($merchants) > 0)
    @if(count($shops = \AnchorCMS\Merchants::getActiveMerchant()->shops()->get()) > 0)
