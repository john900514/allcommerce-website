<template>
    <div class="sms-client-manager">
        <div class="inner-sms-client-manager">
                        ...
                        <div class="inner-list-of-providers">
                            <div class="description-segment">
                                <div class="inner-description-segment">
                                    <p><i>Using an SMS Provider allows you to use amazing features, like the 1-Click
                                        Checkout for Returning and Abandoned Customers! There's no cost to enable SMS
                                        save for a small fee per message fired/received on selected providers (free for
                                        the rest! + their usage fee. Not partnered with a provider? No problem, get
                                        started right away with AllCommerce's built-in provider, powered by Twilio, for
                                        just $0.01/per message!
                                    </i></p>
                                </div>
                            </div>
                            ...
                            <div class="empty-segment" v-else>
