...
<script>
    import shopifyPublishInventoryWidget
        from "../../../components/shopify/polaris-widgets/inventory/publishInventoryContainer";
    export default {
        name: "accountDashboardComponent",
        components: { shopifyPublishInventoryWidget },
