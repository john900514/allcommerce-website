...
class UpdateLeadWithShipping
{
    ...
    public function execute(array $data)
    {
        ...
        if(array_key_exists('shipping', $data))
        {
            ...
            if(array_key_exists('shipping_uuid', $data))
            {
                $ac_lead->setShippingUuid($data['shipping_uuid']);
            }
        ...
        if(array_key_exists('billing', $data))
        {
            ...
            if(array_key_exists('billing_uuid', $data))
            {
                $ac_lead->setBillingUuid($data['billing_uuid']);
            }
        }
