...
class MerchantInventory extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Inventory\InventoryVariants', 'inventory_id', 'platform_id');
    }

    public function variant_options()
    {
        return $this->hasMany('App\Models\Inventory\VariantsOptions', 'inventory_id', 'platform_id');
    }

    public function images()
    {
        return $this->hasMany('App\Models\Inventory\InventoryImages', 'inventory_id', 'platform_id');
    }
